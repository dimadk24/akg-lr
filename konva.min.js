!function (t, e) {
    ...
    var e = function (t) {
            ...
            var i = t.toLowerCase(),
                ...
                r = !!t.match(/Android|BlackBerry|iPhone|iPad|iPod|Opera Mini|IEMobile/i), o = !!t.match(/IEMobile/i);
            return {browser: n[1] || "", version: n[2] || "0", isIE: e(i), mobile: r, ieMobile: o}
        },
    ...
    var h = function () {
        ...
        return t.prototype.reset = function () {
            ...
            var e = Math.cos(t), i = Math.sin(t), n = this.m[0] * e + this.m[2] * i, r = this.m[1] * e + this.m[3] * i,
                o = this.m[0] * -i + this.m[2] * e, a = this.m[1] * -i + this.m[3] * e;
            ...
            var i = this.m[0] + this.m[2] * e, n = this.m[1] + this.m[3] * e, r = this.m[2] + this.m[0] * t,
            ...
            var e = this.m[0] * t.m[0] + this.m[2] * t.m[1], i = this.m[1] * t.m[0] + this.m[3] * t.m[1],
                n = this.m[0] * t.m[2] + this.m[2] * t.m[3], r = this.m[1] * t.m[2] + this.m[3] * t.m[3],
            ...
            var t = 1 / (this.m[0] * this.m[3] - this.m[1] * this.m[2]), e = this.m[3] * t, i = -this.m[1] * t,
                n = -this.m[2] * t, r = this.m[0] * t, o = t * (this.m[2] * this.m[5] - this.m[3] * this.m[4]),
                a = t * (this.m[1] * this.m[4] - this.m[0] * this.m[5]);
            return this.m[0] = e, this.m[1] = i, this.m[2] = n, this.m[3] = r, this.m[4] = o, this.m[5] = a, this
        }, t.prototype.getMatrix = function () {
            return this.m
        }, t.prototype.setAbsolutePosition = function (t, e) {
            var i = this.m[0], n = this.m[1], r = this.m[2], o = this.m[3], a = this.m[4],
                s = (i * (e - this.m[5]) - n * (t - a)) / (i * o - n * r), h = (t - a - r * s) / i;
            return this.translate(h, s)
        }, t.prototype.decompose = function () {
            var t = this.m[0], e = this.m[1], i = this.m[2], n = this.m[3], r = t * n - e * i,
                o = {x: this.m[4], y: this.m[5], rotation: 0, scaleX: 0, scaleY: 0, skewX: 0, skewY: 0};
            if (0 != t || 0 != e) {
        ...
        _isElement: function (t) {
            ...
            if (/hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.test(t)) {
                var e = /hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec(t), i = (e[0], e.slice(1)),
                    n = Number(i[0]) / 360, r = Number(i[1]) / 100, o = Number(i[2]) / 100, a = void 0, s = void 0,
                    h = void 0;
                if (0 === r) return h = 255 * o, {r: Math.round(h), g: Math.round(h), b: Math.round(h), a: 1};
            ...
            var s = Math.sqrt(Math.pow(i - t, 2) + Math.pow(n - e, 2)),
                h = Math.sqrt(Math.pow(r - i, 2) + Math.pow(o - n, 2)), l = a * s / (s + h), c = a * h / (s + h);
            ...
            var n = f.cloneObject(t), r = Number.MAX_VALUE;
            return e.forEach((function (o, a) {
                if (i || a !== e.length - 1) {
                    var s = e[(a + 1) % e.length], h = f._getProjectionToSegment(o.x, o.y, s.x, s.y, t.x, t.y),
                        l = h[0], c = h[1], d = h[2];
                    d < r && (n.x = l, n.y = c, r = d)
                }
            })), n
            ...
            var e;
            for (var i in t.visitedByCircularReferenceRemoval = !0, t) if (t.hasOwnProperty(i) && t[i] && "object" == typeof t[i]) if (e = Object.getOwnPropertyDescriptor(t, i), t[i].visitedByCircularReferenceRemoval || f._isElement(t[i])) {
    ...
    function m(t) {
        if (r.isUnminified) return function (e, i) {
            var n = f._isNumber(e), r = f._isArray(e) && e.length == t;
    ...
    function x() {
        if (r.isUnminified) return function (t, e) {
            var i = f._isString(t), n = "[object CanvasGradient]" === Object.prototype.toString.call(t);
    ...
    var w = {
        addGetterSetter: function (t, e, i, n, r) {
            ...
            var a, s, h = i.length, l = f._capitalize, c = "get" + l(e), d = "set" + l(e);
            ...
            var i = f._capitalize(e), n = "set" + i, r = "get" + i;
            t.prototype[e] = function () {
            ...
            f.each(e, (function (e, i) {
                var n = t.prototype[i], r = "get" + f._capitalize(e), o = "set" + f._capitalize(e);
    ...
    var T = ["arc", "arcTo", "beginPath", "bezierCurveTo", "clearRect", "clip", "closePath", "createLinearGradient", "createPattern", "createRadialGradient", "drawImage", "ellipse", "fill", "fillText", "getImageData", "createImageData", "lineTo", "moveTo", "putImageData", "quadraticCurveTo", "rect", "restore", "rotate", "save", "scale", "setLineDash", "setTransform", "stroke", "strokeText", "transform", "translate"],
        A = function () {
            ...
            return t.prototype.fillShape = function (t) {
                ...
                var t, e, i = this, n = T.length, r = f._simplifyArray, o = this.setAttr, a = function (t) {
                    var n, o = i[t];
                    i[t] = function () {
    ...
    var M, G = function (t) {
        ...
        return P(e, t), e.prototype._fillColor = function (t) {
            ...
            var e = t.getFillPatternX(), i = t.getFillPatternY(), n = r.getAngle(t.getFillPatternRotation()),
                o = t.getFillPatternOffsetX(), a = t.getFillPatternOffsetY();
            ...
            var e = t.getStrokeLinearGradientStartPoint(), i = t.getStrokeLinearGradientEndPoint(),
                n = t.getStrokeLinearGradientColorStops(), r = this.createLinearGradient(e.x, e.y, i.x, i.y);
            if (n) {
            ...
            var e = f, i = e.get(t.getShadowRGBA(), "black"), n = e.get(t.getShadowBlur(), 5),
                r = e.get(t.getShadowOffset(), {x: 0, y: 0}), o = t.getAbsoluteScale(), a = this.canvas.getPixelRatio(),
                s = o.x * a, h = o.y * a;
        ...
        return P(e, t), e.prototype._fill = function (t) {
            ...
            if (t.hasHitStroke()) {
                ...
                var n = t.hitStrokeWidth(), r = "auto" === n ? t.strokeWidth() : n;
    ...
    var E = function (t) {
        ...
        get isDragging() {
            var t = !1;
            return I._dragElements.forEach((function (e) {
            ...
            var e = [];
            I._dragElements.forEach((function (i, n) {
                var r = i.node, o = r.getStage();
            ...
            I._dragElements.forEach((function (e, i) {
                var n = e.node.getStage();
                if (t && n.setPointersPositions(t), n._changedPointerPositions.find((function (t) {
                    return t.id === e.pointerId
                }))) {
                    "dragging" !== e.dragStatus && "stopped" !== e.dragStatus || (I.justDragged = !0, r.listenClickTap = !1, e.dragStatus = "stopped");
            ...
            I._dragElements.forEach((function (e, i) {
                "stopped" === e.dragStatus && e.node.fire("dragend", {
                    ...
                    target: e.node,
                    evt: t
                }, !0), "dragging" !== e.dragStatus && I._dragElements.delete(i)
            }))
        }
    };
    r.isBrowser && (window.addEventListener("mouseup", I._endDragBefore, !0), window.addEventListener("touchend", I._endDragBefore, !0), window.addEventListener("mousemove", I._drag), window.addEventListener("touchmove", I._drag), window.addEventListener("mouseup", I._endDragAfter, !1), window.addEventListener("touchend", I._endDragAfter, !1));
    var D = {}, F = {}, B = function (t, e) {
            t && D[t] === e && delete D[t]
        }, N = function (t, e) {
        ...
        H = new s, Y = 1, X = function () {
            ...
            return t.prototype.hasChildren = function () {
                ...
                var n = Math.ceil(e.width || i.width), r = Math.ceil(e.height || i.height), o = e.pixelRatio,
                    a = void 0 === e.x ? i.x : e.x, s = void 0 === e.y ? i.y : e.y, h = e.offset || 0,
                    l = e.drawBorder || !1;
                if (n && r) {
                    a -= h, s -= h;
                    var c = new E({pixelRatio: o, width: n += 2 * h, height: r += 2 * h}),
                        d = new E({pixelRatio: o, width: 0, height: 0}), u = new O({pixelRatio: 1, width: n, height: r}),
                        p = c.getContext(), g = u.getContext();
                ...
                var i, n, r, o, a = [{x: t.x, y: t.y}, {x: t.x + t.width, y: t.y}, {x: t.x + t.width, y: t.y + t.height}, {
                    x: t.x,
                    y: t.y + t.height
                ...
                var t, e, i, n, r = this.filters(), o = this._getCanvasCache(), a = o.scene, s = o.filter,
                    h = s.getContext();
                if (r) {
                ...
                var i, n, r, o, a = t.split(" "), s = a.length;
                ...
                if (this._cache && this._cache.delete("allEventListeners"), !t) for (n in this.eventListeners) this._off(n);
                ...
                return this.isDragging() && this.stopDrag(), I._dragElements.delete(this._id), this._remove(), this
                ...
                I._dragElements.forEach((function (t) {
                ...
                var t, e, i, n, r = this.getDepth(), o = this, a = 0;
                ...
                e && !t && (t = !0);
                var n = this.getAbsoluteTransform(t).getMatrix(), r = new h, o = this.offset();
                ...
                for (e = 0; e < r; e++) if (i = n[e], f.isValidSelector(i) || (f.warn('Selector "' + i + '" is invalid. Allowed selectors examples are "#foo", ".bar" or "Group".'), f.warn('If you have a custom shape with such className, please change it to start with upper letter like "Triangle".'), f.warn("Konva is awesome, right?")), "#" === i.charAt(0)) {
                ...
                if ("all" === i) e.multiply(this.getTransform()); else if ("position" === i) {
                    var n = this.attrs.x || 0, r = this.attrs.y || 0, o = this.attrs.offsetX || 0,
                ...
                i.reset();
                var n = this.x(), o = this.y(), a = r.getAngle(this.rotation()),
                    s = null !== (t = this.attrs.scaleX) && void 0 !== t ? t : 1,
                    l = null !== (e = this.attrs.scaleY) && void 0 !== e ? e : 1, c = this.attrs.skewX || 0,
                    d = this.attrs.skewY || 0, u = this.attrs.offsetX || 0, p = this.attrs.offsetY || 0;
                ...
                t = t || {};
                var e = this.getClientRect(), i = this.getStage(), n = void 0 !== t.x ? t.x : e.x,
                    r = void 0 !== t.y ? t.y : e.y, o = t.pixelRatio || 1, a = new E({
                ...
                if (!e) {
                    e = {};
                    for (var i = Object.getPrototypeOf(this); i;) if (i.eventListeners) {
                        for (var n in i.eventListeners) {
                            var r = i.eventListeners[n], o = e[n] || [];
                            e[n] = r.concat(o)
                        }
                ...
                void 0 === e && (e = !0), I._dragElements.has(this._id) || this._createDragElement(t), I._dragElements.get(this._id).dragStatus = "dragging", this.fire("dragstart", {
                    type: "dragstart",
                    target: this,
                    evt: t && t.evt
                }, e)
                ...
                if (i) {
                    var n = {x: i.x - e.offset.x, y: i.y - e.offset.y}, r = this.dragBoundFunc();
                    if (void 0 !== r) {
                ...
                var e = I._dragElements.get(this._id);
                e && (e.dragStatus = "stopped"), I._endDragBefore(t), I._endDragAfter(t)
            },t.prototype.setDraggable = function (t) {
                this._setAttr("draggable", t), this._dragChange()
            },t.prototype.isDragging = function () {
                var t = I._dragElements.get(this._id);
                ...
                if (this.attrs.draggable) this._listenDrag(); else {
                    ...
                    var t = I._dragElements.get(this._id), e = t && "dragging" === t.dragStatus,
                        i = t && "ready" === t.dragStatus;
                    e ? this.stopDrag() : i && I._dragElements.delete(this._id)
                }
                ...
                var n, r, a, s = t.prototype.getClassName.call(e), h = e.children;
                if (i && (e.attrs.container = i), o[s] || (f.warn('Can not find a node with class name "' + s + '". Fallback to "Shape".'), s = "Shape"), n = new (0, o[s])(e.attrs), h) for (r = h.length, a = 0; a < r; a++) n.add(t._createNode(h[a]));
                return n
            },t
        }();
    ...
    var U = function (t) {
        ...
        return P(e, t), e.prototype.getChildren = function (t) {
            ...
            var r = this.children;
            return this._validateAdd(n), n._clearCaches(), n.index = r.length, n.parent = this, r.push(n), this._fire("add", {child: n}), this
            ...
            var i = this.getLayer(), n = t || i && i.getCanvas(), r = n && n.getContext(), o = this._getCanvasCache(),
                a = o && o.scene, s = n && n.isCache;
            ...
            var i = this.getLayer(), n = t || i && i.hitCanvas, r = n && n.getContext(), o = this._getCanvasCache();
            if (o && o.hit) {
                r.save();
            ...
            var n = e && e.getContext(), r = this.clipWidth(), o = this.clipHeight(), a = this.clipFunc(),
                s = r && o || a, h = i === this;
            if (s) {
                n.save();
                var l = this.getAbsoluteTransform(i), c = l.getMatrix();
                if (n.transform(c[0], c[1], c[2], c[3], c[4], c[5]), n.beginPath(), a) a.call(this, n, this); else {
                    var d = this.clipX(), u = this.clipY();
                    n.rect(d, u, r, o)
                }
            ...
            var e, i, n, r, o = (t = t || {}).skipTransform, a = t.relativeTo,
                s = {x: 1 / 0, y: 1 / 0, width: 0, height: 0}, h = this;
            ...
            return s = c && void 0 !== e ? {x: e, y: i, width: n - e, height: r - i} : {
                x: 0,
                y: 0,
                width: 0,
                height: 0
    ...
    var q = new Map, K = void 0 !== r._global.PointerEvent;
    ...
    var ot = function (t) {
        ...
        return P(e, t), e.prototype._validateAdd = function (t) {
            ...
            var e = (t = t || {}).x || 0, i = t.y || 0, n = new E({
                width: t.width || this.width(),
                height: t.height || this.height(),
                pixelRatio: t.pixelRatio || 1
            }), r = n.getContext()._context, o = this.children;
            return (e || i) && r.translate(-1 * e, -1 * i), o.each((function (n) {
                if (n.isVisible()) {
            ...
            for (i = r.length - 1; i >= 0; i--) if (n = r[i].getIntersection(t, e)) return n;
            return null
            ...
            this.setPointersPositions(t), this._fire("contentMouseover", {evt: t}), this._fire("mouseover", {
                evt: t,
                target: this,
                currentTarget: this
            })
            ...
            var i = (null === (e = this.targetShape) || void 0 === e ? void 0 : e.getStage()) ? this.targetShape : null,
                n = !I.isDragging || r.hitOnDragEnabled;
            i && n ? (i._fireAndBubble("mouseout", {evt: t}), i._fireAndBubble("mouseleave", {evt: t}), this._fire("mouseleave", {
                evt: t,
                target: this,
                currentTarget: this
            ...
            var i, n = f._getFirstPointerId(t),
                ...
                a = !I.isDragging || r.hitOnDragEnabled;
            if (a) {
                if ((i = this.getIntersection(this.getPointerPosition())) && i.isListening()) a && o !== i ? (o && (o._fireAndBubble("mouseout", {
                    ...
                    evt: t,
                    pointerId: n
                }, o), i._fireAndBubble("mouseenter", {evt: t, pointerId: n}, o), i._fireAndBubble("mousemove", {
                    evt: t,
                    pointerId: n
                    ...
                    evt: t,
                    pointerId: n
                }), o._fireAndBubble("mouseleave", {evt: t, pointerId: n}), this._fire("mouseover", {
                    evt: t,
                    target: this,
                    currentTarget: this,
                    pointerId: n
            ...
            this.setPointersPositions(t);
            var e = f._getFirstPointerId(t), i = this.getIntersection(this.getPointerPosition());
            I.justDragged = !1, r.listenClickTap = !0, i && i.isListening() ? (this.clickStartShape = i, i._fireAndBubble("mousedown", {
                evt: t,
                pointerId: e
            ...
            this.setPointersPositions(t);
            var e = f._getFirstPointerId(t), i = this.getIntersection(this.getPointerPosition()),
                n = this.clickStartShape, o = this.clickEndShape, a = !1;
            r.inDblClickWindow ? (a = !0, clearTimeout(this.dblTimeout)) : I.justDragged || (r.inDblClickWindow = !0, clearTimeout(this.dblTimeout)), this.dblTimeout = setTimeout((function () {
                ...
                currentTarget: this,
                pointerId: e
            })), this._fire("contentMouseup", {evt: t}), r.listenClickTap && (this._fire("contentClick", {evt: t}), a && this._fire("contentDblclick", {evt: t})), r.listenClickTap = !1, t.cancelable && t.preventDefault()
        }, e.prototype._contextmenu = function (t) {
            this.setPointersPositions(t);
            var e = this.getIntersection(this.getPointerPosition());
            e && e.isListening() ? e._fireAndBubble("contextmenu", {evt: t}) : this._fire("contextmenu", {
                evt: t,
                target: this,
                currentTarget: this
            ...
            this._changedPointerPositions.forEach((function (n) {
                ...
                r.listenClickTap = !0, I.justDragged = !1, o && o.isListening() && (r.captureTouchEventsEnabled && o.setPointerCapture(n.id), e.tapStartShape = o, o._fireAndBubble("touchstart", {
                    evt: t,
                    pointerId: n.id
            ...
            var e = this;
            if (this.setPointersPositions(t), !I.isDragging || r.hitOnDragEnabled) {
                var i = !1, n = {};
            ...
            I.isDragging && I.node.preventDefault() && t.cancelable && t.preventDefault()
        }, e.prototype._touchend = function (t) {
            var e = this;
            this.setPointersPositions(t);
            var i = this.tapEndShape, n = !1;
            r.inDblClickWindow ? (n = !0, clearTimeout(this.dblTimeout)) : I.justDragged || (r.inDblClickWindow = !0, clearTimeout(this.dblTimeout)), this.dblTimeout = setTimeout((function () {
                r.inDblClickWindow = !1
            }), r.dblClickWindow);
            var o = !1, a = {}, s = !1, h = !1;
            this._changedPointerPositions.forEach((function (l) {
                ...
                currentTarget: this,
                pointerId: this._changedPointerPositions[0].id
            }), this._fire("contentTouchend", {evt: t}), r.listenClickTap && (this._fire("contentTap", {evt: t}), n && this._fire("contentDbltap", {evt: t})), this.preventDefault() && t.cancelable && t.preventDefault(), r.listenClickTap = !1
        }, e.prototype._wheel = function (t) {
            this.setPointersPositions(t);
            var e = this.getIntersection(this.getPointerPosition());
            e && e.isListening() ? e._fireAndBubble("wheel", {evt: t}) : this._fire("wheel", {
                evt: t,
                target: this,
                currentTarget: this
            ...
            var e = this, i = this._getContentPosition(), n = null, r = null;
            ...
            }], this._changedPointerPositions = [{x: n, y: r, id: f._getFirstPointerId(t)}])
    ...
    var lt = function (t) {
        ...
        return P(e, t), e.prototype.getContext = function () {
            ...
            var i = t || this.hasFill(), n = this.hasStroke(), r = 1 !== this.getAbsoluteOpacity();
            if (i && n && r) return !0;
            var o = this.hasShadow(), a = this.shadowForStrokeEnabled();
            return !!(i && n && o && a)
            ...
            void 0 === t && (t = {});
            var e = t.skipTransform, i = t.relativeTo, n = this.getSelfRect(),
                r = !t.skipStroke && this.hasStroke() && this.strokeWidth() || 0, o = n.width + r, a = n.height + r,
                s = !t.skipShadow && this.hasShadow(), h = s ? this.shadowOffsetX() : 0,
                l = s ? this.shadowOffsetY() : 0, c = o + Math.abs(h), d = a + Math.abs(l),
                u = s && this.shadowBlur() || 0, p = c + 2 * u, f = d + 2 * u, g = 0;
            ...
            var i, n, r = this.getLayer(), o = t || r.getCanvas(), a = o.getContext(), s = this._getCanvasCache(),
                h = this.getSceneFunc(), l = this.hasShadow(), c = o.isCache, d = o.isCache, u = e === this;
            ...
            if (!this.shouldDrawHit(e)) return this;
            var i = this.getLayer(), n = t || i.hitCanvas, r = n && n.getContext(),
                o = this.hitFunc() || this.sceneFunc(), a = this._getCanvasCache(), s = a && a.hit;
            ...
            void 0 === t && (t = 0);
            var e, i, n, r, o, a = this._getCanvasCache(), s = this._getCachedSceneCanvas(), h = a.hit,
                l = h.getContext(), c = h.getWidth(), d = h.getHeight();
    ...
    var ct = [{x: 0, y: 0}, {x: -1, y: -1}, {x: 1, y: -1}, {x: 1, y: 1}, {x: -1, y: 1}], dt = ct.length,
        ut = function (t) {
            function e(e) {
                var i = t.call(this, e) || this;
                return i.canvas = new E, i.hitCanvas = new O({pixelRatio: 1}), i._waitingForDraw = !1, i.on("visibleChange.konva", i._checkVisibility), i._checkVisibility(), i.on("imageSmoothingEnabledChange.konva", i._setSmoothEnabled), i._setSmoothEnabled(), i
            }
            ...
            return P(e, t), e.prototype.createPNGStream = function () {
                ...
                for (var a = 1, s = !1; ;) {
                    for (n = 0; n < dt; n++) {
                        if (r = ct[n], (o = (i = this._getIntersection({
                            x: t.x + r.x * a,
                            y: t.y + r.y * a
                ...
                var e, i, n = this.hitCanvas.pixelRatio,
                    ...
                    o = r[3];
                return 255 === o ? (e = f._rgbToHex(r[0], r[1], r[2]), (i = ht["#" + e]) ? {shape: i} : {antialiased: !0}) : o > 0 ? {antialiased: !0} : {}
            }, e.prototype.drawScene = function (t, e) {
                var i = this.getLayer(), n = t || i && i.getCanvas();
                return this._fire("beforeDraw", {node: this}), this.clearBeforeDraw() && n.getContext().clear(), U.prototype.drawScene.call(this, n, e), this._fire("draw", {node: this}), this
            }, e.prototype.drawHit = function (t, e) {
    ...
    var gt = n.performance && n.performance.now ? function () {
            ...
            return t.prototype.setLayers = function (t) {
                ...
                var t, e, i, n, r, o, a, s, h = {}, l = this.animations;
                for (n = 0; n < l.length; n++) if (e = (t = l[n]).layers, i = t.func, t._updateFrameObject(gt()), o = e.length, !i || !1 !== i.call(t, t.frame)) for (r = 0; r < o; r++) void 0 !== (a = e[r])._id && (h[a._id] = a);
        ...
        }(), yt = {node: 1, duration: 1, easing: 1, onFinish: 1, yoyo: 1}, mt = 0, _t = ["fill", "stroke", "shadowColor"],
        bt = function () {
            ...
            function t(e) {
                var i, n, o = this, a = e.node, s = a._id, h = e.easing || St.Linear, l = !!e.yoyo;
            ...
            return t.prototype._addAttr = function (e, i) {
                var n, r, o, a, s, h, l, c, d = this.node, u = d._id;
                if ((o = t.tweens[u][e]) && delete t.attrs[u][o][e], n = d.getAttr(e), f._isArray(i)) if (r = [], s = Math.max(i.length, n.length), "points" === e && i.length !== n.length && (i.length > n.length ? (l = n, n = f._prepareArrayForTween(n, i, d.closed())) : (h = i, i = f._prepareArrayForTween(i, n, d.closed()))), 0 === e.indexOf("fill")) for (a = 0; a < s; a++) if (a % 2 == 0) r.push(i[a] - n[a]); else {
                    var p = f.colorToRGBA(n[a]);
                    c = f.colorToRGBA(i[a]), n[a] = p, r.push({r: c.r - p.r, g: c.g - p.g, b: c.b - p.b, a: c.a - p.a})
                } else for (a = 0; a < s; a++) r.push(i[a] - n[a]); else -1 !== _t.indexOf(e) ? (n = f.colorToRGBA(n), r = {
                    r: (c = f.colorToRGBA(i)).r - n.r,
                    g: c.g - n.g,
                    b: c.b - n.b,
                    a: c.a - n.a
                }) : r = i - n;
                t.attrs[u][this._id][e] = {start: n, diff: r, end: i, trueEnd: h, trueStart: l}, t.tweens[u][e] = this._id
            }, t.prototype._tweenFunc = function (e) {
                var i, n, r, o, a, s, h, l, c = this.node, d = t.attrs[c._id][this._id];
                for (i in d) {
                    if (r = (n = d[i]).start, o = n.diff, l = n.end, f._isArray(r)) if (a = [], h = Math.max(r.length, l.length), 0 === i.indexOf("fill")) for (s = 0; s < h; s++) s % 2 == 0 ? a.push((r[s] || 0) + o[s] * e) : a.push("rgba(" + Math.round(r[s].r + o[s].r * e) + "," + Math.round(r[s].g + o[s].g * e) + "," + Math.round(r[s].b + o[s].b * e) + "," + (r[s].a + o[s].a * e) + ")"); else for (s = 0; s < h; s++) a.push((r[s] || 0) + o[s] * e); else a = -1 !== _t.indexOf(i) ? "rgba(" + Math.round(r.r + o.r * e) + "," + Math.round(r.g + o.g * e) + "," + Math.round(r.b + o.b * e) + "," + (r.a + o.a * e) + ")" : r + o * e;
                    c.setAttr(i, a)
                }
                ...
                this.tween.onPlay = function () {
                    ...
                    var i = e.node, n = t.attrs[i._id][e._id];
    ...
    var St = {
        ...
        return P(e, t), e.prototype._sceneFunc = function (t) {
            var e = r.getAngle(this.angle()), i = this.clockwise();
    ...
    var kt = function (t) {
        ...
        return P(e, t), e.prototype._sceneFunc = function (e) {
            ...
            var i = 2 * Math.PI, n = this.points(), r = n, o = 0 !== this.tension() && n.length > 4;
            ...
            var l = (Math.atan2(s, a) + i) % i, c = this.pointerLength(), d = this.pointerWidth();
    ...
    var Mt = function (t) {
        ...
        return P(e, t), e.prototype._useBufferCanvas = function () {
            ...
            a && (e = this.attrs.cropWidth, i = this.attrs.cropHeight, n = e && i ? [a, this.cropX(), this.cropY(), e, i, 0, 0, r, o] : [a, 0, 0, r, o]), (this.hasFill() || this.hasStroke()) && (t.beginPath(), t.rect(0, 0, r, o), t.closePath(), t.fillStrokeShape(this)), a && t.drawImage.apply(t, n)
    ...
    var Gt = ["fontFamily", "fontSize", "fontStyle", "padding", "lineHeight", "text", "width"], Rt = Gt.length,
        Lt = function (t) {
            function e(e) {
                var i = t.call(this, e) || this;
            ...
            return P(e, t), e.prototype.getText = function () {
                ...
                if (s && h) {
                    ...
                    h.setAttrs({x: -1 * r, y: -1 * o, width: t, height: e}), s.setAttrs({x: -1 * r, y: -1 * o})
                }
            }, e
        }(ft);
    ...
    var Et = function (t) {
        ...
        return P(e, t), e.prototype._sceneFunc = function (t) {
            var e = this.width(), i = this.height(), n = this.pointerDirection(), r = this.pointerWidth(),
                o = this.pointerHeight(), a = this.cornerRadius(), s = 0, h = 0, l = 0, c = 0;
            ...
            var t = 0, e = 0, i = this.pointerWidth(), n = this.pointerHeight(), r = this.pointerDirection(),
    ...
    var Ot = function (t) {
        ...
        return P(e, t), e.prototype._sceneFunc = function (t) {
            ...
            for (var i = !1, n = 0; n < e.length; n++) {
                var r = e[n].command, o = e[n].points;
                switch (r) {
                    case"L":
                        t.lineTo(o[0], o[1]);
                        break;
                    ...
                    case"Q":
                        ...
                        break;
                    case"A":
                        var a = o[0], s = o[1], h = o[2], l = o[3], c = o[4], d = o[5], u = o[6], p = o[7],
                            f = h > l ? h : l, g = h > l ? 1 : h / l, v = h > l ? l / h : 1;
            ...
            this.dataArray.forEach((function (i) {
                if ("A" === i.command) {
                    var n = i.points[4], r = i.points[5], o = i.points[4] + r, a = Math.PI / 180;
            ...
            return {x: Math.round(r), y: Math.round(a), width: Math.round(o - r), height: Math.round(s - a)}
            ...
            if (n === r) return {x: (i = this.dataArray[n - 1].points.slice(-2))[0], y: i[1]};
            if (t < .01) return {x: (i = this.dataArray[n].points.slice(0, 2))[0], y: i[1]};
            var o = this.dataArray[n], a = o.points;
            switch (o.command) {
                case"L":
                ...
                case"A":
                    var s = a[0], h = a[1], l = a[2], c = a[3], d = a[4], u = a[5], p = a[6];
            ...
            var s = (r - i) / (n - e + 1e-8), h = Math.sqrt(t * t / (1 + s * s));
            n < e && (h *= -1);
            var l, c = s * h;
            if (n === e) l = {x: o, y: a + c}; else if ((a - i) / (o - e + 1e-8) === s) l = {x: o + h, y: a + c}; else {
                var d, u, p = this.getLineLength(e, i, n, r);
                if (p < 1e-8) return;
                var f = (o - e) * (n - e) + (a - i) * (r - i);
                d = e + (f /= p * p) * (n - e), u = i + f * (r - i);
                var g = this.getLineLength(o, a, d, u), v = Math.sqrt(t * t - g * g);
                h = Math.sqrt(v * v / (1 + s * s)), n < e && (h *= -1), l = {x: d + h, y: u + (c = s * h)}
            }
            return l
            ...
            return {x: s * l(t) + o * c(t) + n * d(t) + e * u(t), y: h * l(t) + a * c(t) + r * d(t) + i * u(t)}
            ...
            return {x: o * s(t) + n * h(t) + e * l(t), y: a * s(t) + r * h(t) + i * l(t)}
        }, e.getPointOnEllipticalArc = function (t, e, i, n, r, o) {
            var a = Math.cos(o), s = Math.sin(o), h = i * Math.cos(r), l = n * Math.sin(r);
            ...
            var r, o = e.split("|"), a = [], s = [], h = 0, l = 0,
                c = /([-+]?((\d+\.\d+)|((\d+)|(\.\d+)))(?:e[-+]?\d+)?)/gi;
            for (n = 1; n < o.length; n++) {
                var d = o[n], u = d.charAt(0);
                ...
                for (; p.length > 0 && !isNaN(p[0]);) {
                    ...
                    switch (u) {
                        ...
                        case"L":
                            ...
                            break;
                        case"m":
                            var R = p.shift(), L = p.shift();
                            if (h += R, l += L, T = "M", a.length > 2 && "z" === a[a.length - 1].command) for (var E = a.length - 2; E >= 0; E--) if ("M" === a[E].command) {
                ...
                "z" !== u && "Z" !== u || a.push({command: "z", points: [], start: void 0, pathLength: 0})
            }
            return a
            ...
            switch (n) {
                ...
                case"A":
                    o = 0;
                    var c = r[4], d = r[5], u = r[4] + d, p = Math.PI / 180;
                    if (Math.abs(c - u) < p && (p = Math.abs(c - u)), a = l.getPointOnEllipticalArc(r[0], r[1], r[2], r[3], c, 0), d < 0) for (h = c - p; h > u; h -= p) s = l.getPointOnEllipticalArc(r[0], r[1], r[2], r[3], h, 0), o += l.getLineLength(a.x, a.y, s.x, s.y), a = s; else for (h = c + p; h < u; h += p) s = l.getPointOnEllipticalArc(r[0], r[1], r[2], r[3], h, 0), o += l.getLineLength(a.x, a.y, s.x, s.y), a = s;
            ...
            var l = h * (Math.PI / 180), c = Math.cos(l) * (t - i) / 2 + Math.sin(l) * (e - n) / 2,
                d = -1 * Math.sin(l) * (t - i) / 2 + Math.cos(l) * (e - n) / 2, u = c * c / (a * a) + d * d / (s * s);
            u > 1 && (a *= Math.sqrt(u), s *= Math.sqrt(u));
            var p = Math.sqrt((a * a * (s * s) - a * a * (d * d) - s * s * (c * c)) / (a * a * (d * d) + s * s * (c * c)));
            r === o && (p *= -1), isNaN(p) && (p = 0);
            var f = p * a * d / s, g = p * -s * c / a, v = (t + i) / 2 + Math.cos(l) * f - Math.sin(l) * g,
                y = (e + n) / 2 + Math.sin(l) * f + Math.cos(l) * g, m = function (t) {
                    return Math.sqrt(t[0] * t[0] + t[1] * t[1])
                }, _ = function (t, e) {
                    return (t[0] * e[0] + t[1] * e[1]) / (m(t) * m(e))
                }, b = function (t, e) {
                    return (t[0] * e[1] < t[1] * e[0] ? -1 : 1) * Math.acos(_(t, e))
                }, x = b([1, 0], [(c - f) / a, (d - g) / s]), S = [(c - f) / a, (d - g) / s],
                w = [(-1 * c - f) / a, (-1 * d - g) / s], C = b(S, w);
    ...
    It.prototype.className = "Rect", a(It), w.addGetterSetter(It, "cornerRadius", 0, m(4)), s.mapMethods(It);
    var Dt = function (t) {
        function e() {
            return null !== t && t.apply(this, arguments) || this
        }
    ...
    Dt.prototype.className = "RegularPolygon", Dt.prototype._centroid = !0, Dt.prototype._attrsAffectingSize = ["radius"], a(Dt), w.addGetterSetter(Dt, "radius", 0, y()), w.addGetterSetter(Dt, "sides", 0, y()), s.mapMethods(Dt);
    var Ft = 2 * Math.PI, Bt = function (t) {
        function e() {
            return null !== t && t.apply(this, arguments) || this
        }
    ...
    var Nt = function (t) {
        ...
        return P(e, t), e.prototype._sceneFunc = function (t) {
            var e = this.animation(), i = this.frameIndex(), n = 4 * i, r = this.animations()[e],
                o = this.frameOffsets(), a = r[n + 0], s = r[n + 1], h = r[n + 2], l = r[n + 3], c = this.image();
            ...
            var e = this.animation(), i = this.frameIndex(), n = 4 * i, r = this.animations()[e],
                o = this.frameOffsets(), a = r[n + 2], s = r[n + 3];
            if (t.beginPath(), o) {
                var h = o[e], l = 2 * i;
    ...
    var zt = function (t) {
        ...
        return P(e, t), e.prototype._sceneFunc = function (t) {
            ...
            for (var r = 1; r < 2 * n; r++) {
                var o = r % 2 == 0 ? i : e, a = o * Math.sin(r * Math.PI / n), s = -1 * o * Math.cos(r * Math.PI / n);
                t.lineTo(a, s)
            }
            t.closePath(), t.fillStrokeShape(this)
        }, e.prototype.getWidth = function () {
    ...
    var Ut = function (t) {
        ...
        return P(e, t), e.prototype._sceneFunc = function (t) {
            ...
            if (this.text()) {
                var n, r = this.padding(), o = this.fontSize(), a = this.lineHeight() * o, s = this.verticalAlign(),
                    h = 0, l = this.align(), c = this.getWidth(), d = this.letterSpacing(), u = this.fill(),
                    p = this.textDecoration(), f = -1 !== p.indexOf("underline"), g = -1 !== p.indexOf("line-through"),
                    v = 0, y = (v = a / 2, 0), m = 0;
                for (t.setAttr("font", this._getContextFont()), t.setAttr("textBaseline", "middle"), t.setAttr("textAlign", "left"), "middle" === s ? h = (this.getHeight() - i * a - 2 * r) / 2 : "bottom" === s && (h = this.getHeight() - i * a - 2 * r), t.translate(r, h + r), n = 0; n < i; n++) {
                    y = 0, m = 0;
                    var _, b, x, S = e[n], w = S.text, C = S.width, P = n !== i - 1;
            ...
            var t = this.text().split("\n"), e = +this.fontSize(), i = 0, n = this.lineHeight() * e,
                r = this.attrs.width, o = this.attrs.height, a = "auto" !== r && void 0 !== r,
                s = "auto" !== o && void 0 !== o, h = this.padding(), l = r - 2 * h, c = o - 2 * h, d = 0,
                u = this.wrap(), p = "none" !== u, f = "char" !== u && p, g = this.ellipsis();
            this.textArr = [], jt().font = this._getContextFont();
            for (var v = g ? this._getTextWidth("…") : 0, y = 0, m = t.length; y < m; ++y) {
                var _ = t[y], b = this._getTextWidth(_);
                if (a && b > l) for (; _.length > 0;) {
                    for (var x = 0, S = _.length, w = "", C = 0; x < S;) {
                        var P = x + S >>> 1, k = _.slice(0, P + 1), T = this._getTextWidth(k) + v;
    ...
    var Vt = function (t) {
        ...
        return P(e, t), e.prototype._sceneFunc = function (t) {
            ...
            var t = this, e = this._getTextSize(this.attrs.text), i = this.letterSpacing(), n = this.align(),
                r = this.kerningFunc();
            ...
            for (var l, c, d, u = Wt(this.text()), p = this.text().split(" ").length - 1, f = -1, g = 0, v = function () {
                ...
                " " === e && "justify" === n && (r += (a - o) / p);
                var s = 0, h = 0;
                for (c = void 0; Math.abs(r - s) / r > .01 && h < 25;) {
                    h++;
                    ...
                    switch (d.command) {
                        case"L":
                            ...
                            break;
                        case"A":
                            var y = d.points[4], m = d.points[5], _ = d.points[4] + m;
                            ...
                            break;
                        case"C":
                            0 === g ? g = r > d.pathLength ? 1e-8 : r / d.pathLength : r > s ? g += (r - s) / d.pathLength : g -= (s - r) / d.pathLength, g > 1 && (g = 1, f = !0), c = Ot.getPointOnCubicBezier(g, d.start.x, d.start.y, d.points[0], d.points[1], d.points[2], d.points[3], d.points[4], d.points[5]);
                            break;
                        case"Q":
            ...
            for (var b = 0; b < u.length && (y(u[b]), void 0 !== l && void 0 !== c); b++) {
                var x = Ot.getLineLength(l.x, l.y, c.x, c.y), S = 0;
                if (r) try {
                ...
                var w = Ot.getPointOnLine(S + x / 2, l.x, l.y, c.x, c.y), C = Math.atan2(c.y - l.y, c.x - l.x);
                this.glyphInfo.push({transposeX: w.x, transposeY: w.y, text: u[b], rotation: C, p0: l, p1: c}), l = c
            }
        }, e.prototype.getSelfRect = function () {
            ...
            var h = this.fontSize();
            return {x: n - h / 2, y: o - h / 2, width: r - n + h, height: a - o + h}
        }, e
    }(lt);
        ...
        return P(e, t), e.prototype.attachTo = function (t) {
            ...
            return void 0 === t && (t = []), this._nodes && this._nodes.length && this.detach(), this._nodes = t, 1 === t.length ? this.rotation(t[0].rotation()) : this.rotation(0), this._nodes.forEach((function (t) {
                var i = t._attrsAffectingSize.map((function (t) {
                    ...
                    1 === e.nodes().length && e.rotation(e.nodes()[0].rotation()), e._resetTransformCache(), e._transforming || e.update()
                };
            ...
            t.on("dragstart.tr-konva", (function (n) {
                ...
                if (e) {
                    var r = t.getAbsolutePosition(), o = r.x - e.x, a = r.y - e.y;
                    i.nodes().forEach((function (e) {
                        if (e !== t && !e.isDragging()) {
                            var i = e.getAbsolutePosition();
                            e.setAbsolutePosition({x: i.x + o, y: i.y + a}), e.startDrag(n)
                        }
                    })), e = null
                }
            }))
            ...
            var n = t.getClientRect({skipTransform: !0, skipShadow: !0, skipStroke: this.ignoreStroke()}),
                o = t.getAbsoluteScale(i), a = t.getAbsolutePosition(i), s = n.x * o.x - t.offsetX() * o.x,
            ...
            this.nodes().map((function (i) {
                var n = i.getClientRect({skipTransform: !0, skipShadow: !0, skipStroke: t.ignoreStroke()}),
                    r = [{x: n.x, y: n.y}, {x: n.x + n.width, y: n.y}, {x: n.x + n.width, y: n.y + n.height}, {
                        x: n.x,
                        y: n.y + n.height
            ...
            return {x: l.x, y: l.y, width: o - i, height: a - n, rotation: r.getAngle(this.rotation())}
            ...
            i.on("mousedown touchstart", (function (t) {
                ...
                var n = r.getAngle(e.rotation()), o = function (t, e) {
            ...
            var e, i, n, o = this.findOne("." + this._movingAnchorName), a = o.getStage();
            a.setPointersPositions(t);
            var s = a.getPointerPosition(), h = {x: s.x - this._anchorDragOffset.x, y: s.y - this._anchorDragOffset.y},
            ...
            if (l.x !== c.x || l.y !== c.y) if ("rotater" !== this._movingAnchorName) {
                var d = this.keepRatio() || t.shiftKey, u = this.centeredScaling() || t.altKey;
                if ("top-left" === this._movingAnchorName) {
                    if (d) {
                        var p = u ? {x: this.width() / 2, y: this.height() / 2} : {
                    ...
                    if (d) {
                        p = u ? {x: this.width() / 2, y: this.height() / 2} : {
                ...
                if (u = this.centeredScaling() || t.altKey) {
                    var y = this.findOne(".top-left"), m = this.findOne(".bottom-right"), _ = y.x(), b = y.y(),
                        x = this.getWidth() - m.x(), S = this.getHeight() - m.y();
                ...
                this._fitNodesInto({x: e, y: i, width: C, height: P, rotation: r.getAngle(this.rotation())}, t)
            } else {
                var k = this._getNodeRect();
                e = o.x() - k.width / 2, i = -o.y() + k.height / 2;
                var T = Math.atan2(-i, e) + Math.PI / 2;
                k.height < 0 && (T -= Math.PI);
                var A = r.getAngle(this.rotation()) + T, M = r.getAngle(this.rotationSnapTolerance()),
                    G = ie(k, function (t, e, i) {
                        for (var n = e, o = 0; o < t.length; o++) {
                            var a = r.getAngle(t[o]), s = Math.abs(a - e) % (2 * Math.PI);
            ...
            var i = this, n = this._getNodeRect();
            if (f._inRange(t.width, 2 * -this.padding() - 1, 1)) this.update(); else if (f._inRange(t.height, 2 * -this.padding() - 1, 1)) this.update(); else {
                ...
                this._nodes.forEach((function (t) {
                    var n = t.getParent().getAbsoluteTransform(), r = t.getTransform().copy();
                    r.translate(t.offsetX(), t.offsetY());
                    var o = new h;
                    o.multiply(n.copy().invert()).multiply(d).multiply(n).multiply(r);
                    var a = o.decompose();
                    t.setAttrs(a), i._fire("transform", {evt: e, target: t}), t._fire("transform", {evt: e, target: t})
            ...
            this.rotation(f._getRotation(e.rotation));
            var i = e.width, n = e.height, r = this.enabledAnchors(), o = this.resizeEnabled(), a = this.padding(),
                s = this.anchorSize();
            this.find("._anchor").each((function (e) {
                ...
                x: i / 2,
                y: -this.rotateAnchorOffset() * f._sign(n) - a,
    ...
    return w.addGetterSetter(X, "threshold", .5, y(), w.afterSetFilter), wt.Util._assign(wt, {
        ...
        Filters: {
            Blur: function (t) {
                ...
                e > 0 && function (t, e) {
                    var i, n, r, o, a, s, h, l, c, d, u, p, f, g, v, y, m, _, b, x, S, w, C, P, k = t.data, T = t.width,
                        A = t.height, M = e + e + 1, G = T - 1, R = A - 1, L = e + 1, E = L * (L + 1) / 2, O = new oe,
                        I = null, D = O, F = null, B = null, N = ae[e], z = se[e];
                    for (r = 1; r < M; r++) D = D.next = new oe, r === L && (I = D);
                    for (D.next = O, h = s = 0, n = 0; n < A; n++) {
                        for (y = m = _ = b = l = c = d = u = 0, p = L * (x = k[s]), f = L * (S = k[s + 1]), g = L * (w = k[s + 2]), v = L * (C = k[s + 3]), l += E * x, c += E * S, d += E * w, u += E * C, D = O, r = 0; r < L; r++) D.r = x, D.g = S, D.b = w, D.a = C, D = D.next;
                        for (r = 1; r < L; r++) o = s + ((G < r ? G : r) << 2), l += (D.r = x = k[o]) * (P = L - r), c += (D.g = S = k[o + 1]) * P, d += (D.b = w = k[o + 2]) * P, u += (D.a = C = k[o + 3]) * P, y += x, m += S, _ += w, b += C, D = D.next;
                        for (F = O, B = I, i = 0; i < T; i++) k[s + 3] = C = u * N >> z, 0 !== C ? (C = 255 / C, k[s] = (l * N >> z) * C, k[s + 1] = (c * N >> z) * C, k[s + 2] = (d * N >> z) * C) : k[s] = k[s + 1] = k[s + 2] = 0, l -= p, c -= f, d -= g, u -= v, p -= F.r, f -= F.g, g -= F.b, v -= F.a, o = h + ((o = i + e + 1) < G ? o : G) << 2, l += y += F.r = k[o], c += m += F.g = k[o + 1], d += _ += F.b = k[o + 2], u += b += F.a = k[o + 3], F = F.next, p += x = B.r, f += S = B.g, g += w = B.b, v += C = B.a, y -= x, m -= S, _ -= w, b -= C, B = B.next, s += 4;
                        h += T
                    }
                    for (i = 0; i < T; i++) {
                        for (m = _ = b = y = c = d = u = l = 0, p = L * (x = k[s = i << 2]), f = L * (S = k[s + 1]), g = L * (w = k[s + 2]), v = L * (C = k[s + 3]), l += E * x, c += E * S, d += E * w, u += E * C, D = O, r = 0; r < L; r++) D.r = x, D.g = S, D.b = w, D.a = C, D = D.next;
                        for (a = T, r = 1; r <= e; r++) s = a + i << 2, l += (D.r = x = k[s]) * (P = L - r), c += (D.g = S = k[s + 1]) * P, d += (D.b = w = k[s + 2]) * P, u += (D.a = C = k[s + 3]) * P, y += x, m += S, _ += w, b += C, D = D.next, r < R && (a += T);
                        for (s = i, F = O, B = I, n = 0; n < A; n++) k[(o = s << 2) + 3] = C = u * N >> z, C > 0 ? (C = 255 / C, k[o] = (l * N >> z) * C, k[o + 1] = (c * N >> z) * C, k[o + 2] = (d * N >> z) * C) : k[o] = k[o + 1] = k[o + 2] = 0, l -= p, c -= f, d -= g, u -= v, p -= F.r, f -= F.g, g -= F.b, v -= F.a, o = i + ((o = n + L) < R ? o : R) * T << 2, l += y += F.r = k[o], c += m += F.g = k[o + 1], d += _ += F.b = k[o + 2], u += b += F.a = k[o + 3], F = F.next, p += x = B.r, f += S = B.g, g += w = B.b, v += C = B.a, y -= x, m -= S, _ -= w, b -= C, B = B.next, s += T
                    }
                }(t, e)
            }, Brighten: function (t) {
                ...
                var e, i = Math.pow((this.contrast() + 100) / 100, 2), n = t.data, r = n.length, o = 150, a = 150,
                    s = 150;
                ...
                var e = 10 * this.embossStrength(), i = 255 * this.embossWhiteLevel(), n = this.embossDirection(),
                    r = this.embossBlend(), o = 0, a = 0, s = t.data, h = t.width, l = t.height, c = 4 * h, d = l;
                switch (n) {
                    case"top-left":
                        o = -1, a = -1;
                        break;
                ...
                do {
                    ...
                    do {
                        var y = u + 4 * (v - 1), m = a;
                        v + m < 1 && (m = 0), v + m > h && (m = 0);
                        var _ = g + 4 * (v - 1 + m), b = s[y] - s[_], x = s[y + 1] - s[_ + 1], S = s[y + 2] - s[_ + 2],
                            w = b, C = w > 0 ? w : -w;
                        if ((x > 0 ? x : -x) > C && (w = x), (S > 0 ? S : -S) > C && (w = S), w *= e, r) {
                            var P = s[y] + w, k = s[y + 1] + w, T = s[y + 2] + w;
                ...
                var e, i, n, r, o = t.data, a = o.length, s = o[0], h = s, l = o[1], c = l, d = o[2], u = d,
                    p = this.enhance();
                if (0 !== p) {
                ...
                var e, i, n, r, o, a = t.data, s = a.length, h = Math.pow(2, this.saturation()),
                    l = Math.abs(this.hue() + 360) % 360, c = 127 * this.luminance(),
                    d = 1 * h * Math.cos(l * Math.PI / 180), u = 1 * h * Math.sin(l * Math.PI / 180),
                    p = .299 + .701 * d + .167 * u, f = .587 - .587 * d + .33 * u, g = .114 - .114 * d - .497 * u,
                    v = .299 - .299 * d - .328 * u, y = .587 + .413 * d + .035 * u, m = .114 - .114 * d + .293 * u,
                    _ = .299 - .3 * d + 1.25 * u, b = .587 - .586 * d - 1.05 * u, x = .114 + .886 * d - .2 * u;
                for (e = 0; e < s; e += 4) i = a[e + 0], n = a[e + 1], r = a[e + 2], o = a[e + 3], a[e + 0] = p * i + f * n + g * r + c, a[e + 1] = v * i + y * n + m * r + c, a[e + 2] = _ * i + b * n + x * r + c, a[e + 3] = o
            }, HSV: function (t) {
                var e, i, n, r, o, a = t.data, s = a.length, h = Math.pow(2, this.value()),
                    l = Math.pow(2, this.saturation()), c = Math.abs(this.hue() + 360) % 360,
                    d = h * l * Math.cos(c * Math.PI / 180), u = h * l * Math.sin(c * Math.PI / 180),
                    p = .299 * h + .701 * d + .167 * u, f = .587 * h - .587 * d + .33 * u,
                    g = .114 * h - .114 * d - .497 * u, v = .299 * h - .299 * d - .328 * u,
                    y = .587 * h + .413 * d + .035 * u, m = .114 * h - .114 * d + .293 * u,
                    _ = .299 * h - .3 * d + 1.25 * u, b = .587 * h - .586 * d - 1.05 * u,
                    x = .114 * h + .886 * d - .2 * u;
                ...
                var e, i, n, r, o, a, s, h, l, c = t.width, d = t.height, u = Math.round(this.kaleidoscopePower()),
                    p = Math.round(this.kaleidoscopeAngle()), g = Math.floor(c * (p % 360) / 360);
                if (!(u < 1)) {
                    var v = f.createCanvasElement();
                    v.width = c, v.height = d;
                    var y = v.getContext("2d").getImageData(0, 0, c, d);
                    !function (t, e, i) {
                        var n, r, o, a, s = t.data, h = e.data, l = t.width, c = t.height, d = i.polarCenterX || l / 2,
                            u = i.polarCenterY || c / 2, p = 0, f = 0, g = 0, v = 0, y = Math.sqrt(d * d + u * u);
                        r = l - d, o = c - u, y = (a = Math.sqrt(r * r + o * o)) > y ? a : y;
                        var m, _, b, x, S = c, w = l, C = 360 / w * Math.PI / 180;
                        for (_ = 0; _ < w; _ += 1) for (b = Math.sin(_ * C), x = Math.cos(_ * C), m = 0; m < S; m += 1) r = Math.floor(d + y * m / S * x), p = s[(n = 4 * ((o = Math.floor(u + y * m / S * b)) * l + r)) + 0], f = s[n + 1], g = s[n + 2], v = s[n + 3], h[(n = 4 * (_ + m * l)) + 0] = p, h[n + 1] = f, h[n + 2] = g, h[n + 3] = v
                    }(t, y, {polarCenterX: c / 2, polarCenterY: d / 2});
                    for (var m = c / Math.pow(2, u); m <= 8;) m *= 2, u -= 1;
                    var _ = m = Math.ceil(m), b = 0, x = _, S = 1;
                    for (g + m > c && (b = _, x = 0, S = -1), i = 0; i < d; i += 1) for (e = b; e !== x; e += S) h = 4 * (c * i + Math.round(e + g) % c), r = y.data[h + 0], o = y.data[h + 1], a = y.data[h + 2], s = y.data[h + 3], l = 4 * (c * i + e), y.data[l + 0] = r, y.data[l + 1] = o, y.data[l + 2] = a, y.data[l + 3] = s;
                    ...
                    !function (t, e, i) {
                        var n, r, o, a, s, h, l = t.data, c = e.data, d = t.width, u = t.height,
                            p = i.polarCenterX || d / 2, f = i.polarCenterY || u / 2, g = 0, v = 0, y = 0, m = 0,
                            _ = Math.sqrt(p * p + f * f);
                        r = d - p, o = u - f, _ = (h = Math.sqrt(r * r + o * o)) > _ ? h : _;
                        var b, x, S, w = u, C = d, P = i.polarRotation || 0;
                        for (r = 0; r < d; r += 1) for (o = 0; o < u; o += 1) a = r - p, s = o - f, b = Math.sqrt(a * a + s * s) * w / _, x = (x = (180 * Math.atan2(s, a) / Math.PI + 360 + P) % 360) * C / 360, S = Math.floor(x), g = l[(n = 4 * (Math.floor(b) * d + S)) + 0], v = l[n + 1], y = l[n + 2], m = l[n + 3], c[(n = 4 * (o * d + r)) + 0] = g, c[n + 1] = v, c[n + 2] = y, c[n + 3] = m
                    }(y, t, {polarRotation: 0})
                }
            }, Mask: function (t) {
                var e = function (t, e) {
                    var i = le(t, 0, 0), n = le(t, t.width - 1, 0), r = le(t, 0, t.height - 1),
                        o = le(t, t.width - 1, t.height - 1), a = e || 10;
                ...
                return e && function (t, e) {
                    ...
                    for (var n = [1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9], r = Math.round(Math.sqrt(n.length)), o = Math.floor(r / 2), a = [], s = 0; s < i; s++) for (var h = 0; h < e; h++) {
                        for (var l = s * e + h, c = 0, d = 0; d < r; d++) for (var u = 0; u < r; u++) {
                            var p = s + d - o, f = h + u - o;
                            if (p >= 0 && p < i && f >= 0 && f < e) {
                                var g = n[d * r + u];
                                c += t[p * e + f] * g
                ...
                var e, i, n, r, o, a, s, h, l, c, d, u, p, g, v = Math.ceil(this.pixelSize()), y = t.width,
                    m = t.height, _ = Math.ceil(y / v), b = Math.ceil(m / v), x = t.data;
                if (v <= 0) f.error("pixelSize value can not be <= 0"); else for (u = 0; u < _; u += 1) for (p = 0; p < b; p += 1) {
                    for (r = 0, o = 0, a = 0, s = 0, l = (h = u * v) + v, d = (c = p * v) + v, g = 0, e = h; e < l; e += 1) if (!(e >= y)) for (i = c; i < d; i += 1) i >= m || (r += x[(n = 4 * (y * i + e)) + 0], o += x[n + 1], a += x[n + 2], s += x[n + 3], g += 1);
                    for (r /= g, o /= g, a /= g, s /= g, e = h; e < l; e += 1) if (!(e >= y)) for (i = c; i < d; i += 1) i >= m || (x[(n = 4 * (y * i + e)) + 0] = r, x[n + 1] = o, x[n + 2] = a, x[n + 3] = s)
                }
                ...
                var e = t.data, i = t.width, n = 4 * i, r = t.height;
                do {
                    var o = (r - 1) * n, a = i;
                    do {
                        var s = o + 4 * (a - 1), h = e[s], l = e[s + 1], c = e[s + 2];
